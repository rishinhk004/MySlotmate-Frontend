      ...
      {!eventHasPassed && (
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full appearance-none rounded-lg border border-gray-200 bg-white px-4 py-3 outline-none focus:border-transparent focus:ring-2 focus:ring-[#0094CA]"
          >
            {Array.from(
              { length: Math.min(spotsLeft, 10) },
              (_, i) => i + 1,
            ).map((n) => (
