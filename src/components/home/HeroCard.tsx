...
const HeroCard=({photo,type,title,description,duration}:CardProps)=>{
    ...
    return(
        <>
            <div className="flex flex-row rounded-2xl w-[18rem] h-[8rem] bg-[#ffffff] scale-100 md:scale-105 lg:scale-120 transition-transform duration-300 mt-4 border-2 border-[#6B7280]" style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
