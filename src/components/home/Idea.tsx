        ...
        <div className="flex flex-col items-center justify-center rounded-2xl w-full lg:w-[80vw] p-8" style={{background: "linear-gradient(180deg, rgba(0, 148, 202, 0.1) 0%, rgba(255, 255, 255, 0.1) 100.13%)",border: "1.63px solid #0094CA33"}}>
            ...
            <div className="flex flex-col md:flex-row items-center justify-around text-center">
                <div className="flex flex-col items-center justify-center">
                    <div className="flex items-center justify-center h-[4rem] w-[4rem] bg-[#0094CA1A] rounded-full p-2"><img src="/assets/home/real.svg" alt="Real People" /></div>
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="flex items-center justify-center h-[4rem] w-[4rem] bg-[#0094CA1A] rounded-full p-2"><img src="/assets/home/icon.svg" alt="Right Fit" /></div>   
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="flex items-center justify-center h-[4rem] w-[4rem] bg-[#0094CA1A] rounded-full p-2"><img src="/assets/home/spark.svg" alt="Book Now" /></div>
                    <h1>Book Now</h1>
